...
export const sampadaProjects = [
    ...
    },
    {
        ...
        photo:"/assets/graphics/publications/sampada-publication3.png", 
...
export const leadershipArticles = [
    ...
    {id:"gsliasion", title:"Women in MechE Graduate Student Liason", date:"Fall 2024-Spring 2025", prev:"Facilitated academic, career, and social opportunities for the women in the mechanical engineering department.", imgsrc:"/assets/leadership/women.png", article:"https://www.instagram.com/womeninmechecmu/?hl=en"},
    {id:"megsoliason", title:"MEGSO's Department Liaison", date:"Fall 2023- Spring 2024", prev:"(MechE Graduate Student Organization) Worked with the academic committee to create tax, housing, financial, TA and career resources for graduate students within the department", imgsrc:"/assets/leadership/megso.png", article:"https://meche.engineering.cmu.edu/education/graduate-programs/graduate-activities.html"},
    {id:"international", title:"CMU GSA International Student Advocate", date:"Fall 2021- Spring 2023", prev:"Compiled and shared a tax resource for international students in collaboration with the Office of International Education at CMU.", imgsrc:"/assets/leadership/gsa.jpg", article:""},
    {id:"meche-ms", title:"MechE MS Student Ambassador", date:"November 2019- May 2021", prev:"Served as the liaison between the mechanical engineering department and master's student community at CMU.", imgsrc:"/assets/leadership/mechengsa.jpg", article:""},
...
export const conferences= [
    ...
    {id:"mit", title:"MIT A+B Applied Energy Symposium", date:"August 12-15, 2024", prev:"Attended the MIT A+B Applied Energy Symposium where work on \"Using Microwave Irradiations to Reduce CO 2 Emissions from Alumina Ceramic Sintering Process\" was presented.", imgsrc:"/assets/leadership/mit.png", article:"https://www.youtube.com/watch?v=XR5_qXpkGAs"},
